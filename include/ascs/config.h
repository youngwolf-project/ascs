 ...
 *
 * ===============================================================
 * 2026.5.1		version 1.8.1
 *
 * SPECIAL ATTENTION (incompatible with old editions):
 * Macro ASCS_CAN_EMPTY_NOT_SAFE and ASCS_ARBITRARY_SEND are removed, then your queue must provide 'is_empty' function.
 *
 * HIGHLIGHT:
 *
 * FIX:
 ...
 *
 * DELETION:
 * Delete macro ASCS_CAN_EMPTY_NOT_SAFE and ASCS_ARBITRARY_SEND, then your queue must provide 'is_empty' function,
